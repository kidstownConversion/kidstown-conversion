// Converted from scripts/school/FarmTown4.pl; original top-level HTML output.
...
<BR>
Some of the vegetables are <a href="{{engine}}?KEY=4541">corn</A>
and <a href="{{engine}}?KEY=4545">pumpkins</A>.
<BR>
Some of the grains are <a href="{{engine}}?KEY=4542">hay</A>
and <a href="{{engine}}?KEY=4544">wheat</A>.</FONT></P>
...
<BR>
Some of the fruits are <a href="{{engine}}?KEY=4546">apples</A>,
<a href="{{engine}}?KEY=4547">oranges</A>
and <a href="{{engine}}?KEY=4548">grapes</A>.
</P>

<P ALIGN="CENTER"><IMG SRC="{{schoolgraphics}}/AZO00008.GIF"
