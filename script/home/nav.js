  ...
  return `
    <table cellspacing="0" cellpadding="6" border="0">
      <tr>
        ...
        <td><a href="#" data-key="4000"><img src="${config.homeGraphics}/navbtn_school.gif"><br>School</a></td>
        <td><a href="#" data-key="6000"><img src="${config.homeGraphics}/navbtn_library.gif"><br>Library</a></td>
        <td><a href="#" data-key="9000"><img src="${config.homeGraphics}/navbtn_zoo.gif"><br>Zoo</a></td>
        ...
        <td><a href="#" data-key="3000"><img src="${config.homeGraphics}/navbtn_township.gif"><br>TownShip</a></td>
        <td><a href="#" data-key="8000"><img src="${config.homeGraphics}/navbtn_museum.gif"><br>Museum</a></td>
